...
typedef void(*ExportProgressHandler)(uint32_t Progress);
typedef void(*ExportStatusHandler)(uint32_t AssetIndex);
...
public:
    ...
    static void ExportAllAssets(List<CoDAsset_t*> LoadedAssets, ExportProgressCallback ProgressCallback, CheckStatusCallback StatusCallback, Forms::Form* MainForm);
    // Export selected indicies only
    static void ExportSelection(List<CoDAsset_t*> LoadedAssets, ExportProgressCallback ProgressCallback, CheckStatusCallback StatusCallback, Forms::Form* MainForm);
    ...
    static std::unique_ptr<Assets::Model> BuildPreviewModel(const CoDModel_t* Model);

    static std::unique_ptr<Assets::Model> BuildPreviewMdl(const CoDModel_t* Model);

    static std::unique_ptr<Assets::Texture> BuildPreviewTexture(Assets::MaterialSlotType type, uint64_t texture);

    static ImageUsageType ImageUseFromMaterialSlot(Assets::MaterialSlotType type);

    static std::unique_ptr<Assets::Texture> BuildPreviewTexture(const CoDImage_t* texture);

    static std::unique_ptr<Assets::Texture> BuildPreviewMaterial(const CoDMaterial_t* texture);
...
private:
    ...
    static string BuildExportPath(const CoDAsset_t* Asset);
    ...
    static void ExportSelectedAssets(const List<CoDAsset_t*>& Assets, ExportProgressCallback ProgressCallback, CheckStatusCallback StatusCallback, Forms::Form* MainForm);
