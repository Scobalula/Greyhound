...
public:
    ...
    static void LoadXModel(const XModelLod_t& ModelLOD, const std::unique_ptr<Assets::Model>& ResultModel);

    static void LoadXModel(const XModelLod_t& ModelLOD, const std::unique_ptr<Assets::Model>& ResultModel, const std::unique_ptr<WraithModel>& WraithModel);
