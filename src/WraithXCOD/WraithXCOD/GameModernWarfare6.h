...
// Handles reading from Modern Warfare 6
class GameModernWarfare6
{
public:
    // -- Game functions

    // Loads offsets for Modern Warfare 6
    static bool LoadOffsets();
    // Loads assets for Modern Warfare 6
    static bool LoadAssets();

    // Reads an XAnim from Modern Warfare 6
    static std::unique_ptr<XAnim_t> ReadXAnim(const CoDAnim_t* Animation);
    // Reads a XModel from Modern Warfare 6
    static std::unique_ptr<XModel_t> ReadXModel(const CoDModel_t* Model);
    // Reads a XImage from Modern Warfare 6
    static std::unique_ptr<XImageDDS> ReadXImage(const CoDImage_t* Image);
    // Reads an XSound from Modern Warfare 6
    ...
    // Reads an XImageDDS from a image reference from Modern Warfare 6
    ...
    // String Handlers for Modern Warfare 6
