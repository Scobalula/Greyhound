...
void Cast::ExportCastModel(const WraithModel& Model, const std::string& FileName, bool SupportsScale)
{
	...
	{
		auto CastMaterial = CastModel->AddNode(CastNodeId::Material, Hashing::XXHash::HashString(Material.MaterialName.c_str()));
		...
		auto CastDiffuse = CastMaterial->AddNode(CastNodeId::File, Hashing::XXHash::HashString(Material.DiffuseMapName.c_str()));
		...
		auto CastNormal = CastMaterial->AddNode(CastNodeId::File, Hashing::XXHash::HashString(Material.NormalMapName.c_str()));
		CastNormal->SetProperty("p", Material.NormalMapName);
		CastMaterial->SetProperty("normal", CastPropertyId::Integer64, CastNormal->Hash);
		auto CastSpec = CastMaterial->AddNode(CastNodeId::File, Hashing::XXHash::HashString(Material.SpecularMapName.c_str()));
