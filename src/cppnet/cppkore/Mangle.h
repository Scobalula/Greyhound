...
typedef HGLRC(__stdcall* WFnCreateContextAttribsARB)(HDC hdc, HGLRC hShareContext,const int* attribList);
...
extern WFnCreateContextAttribsARB wglCreateContextAttribsARB;
