...
void XAnimProduceQuaternions(BinaryWriter& Writer, uint32_t FrameSize, uint32_t LoopedFrameCount, const std::vector<WraithAnimFrame<Math::Quaternion>>& QuatFrames, bool SimpleQuaternion = false)
{
