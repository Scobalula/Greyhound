...
public:
    ...
    static std::unique_ptr<DirectX::ScratchImage> GenerateDirectXScratch(int8_t* ImageBuffer, uint64_t ImageSize, ImageFormat InFormat);
    ...
    static std::unique_ptr<DirectX::ScratchImage> GenerateDirectXScratch(const std::shared_ptr<int8_t[]>& ImageBuffer, uint64_t ImageSize, ImageFormat InFormat);
